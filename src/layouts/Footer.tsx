      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <img src={logo} alt="Uva Event Masters" className="h-14 brightness-0 invert" />
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted platform for discovering and managing events in Sri Lanka. Connect with organizers and attendees nationwide.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:contact@uvaeventmasters.lk" className="text-gray-400 hover:text-indigo-400 transition-colors">
                  contact@uvaeventmasters.lk
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-indigo-400" />
                <a href="tel:+94775551234" className="text-gray-400 hover:text-indigo-400 transition-colors">
                  +94 77 555 1234
                </a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-indigo-400 mt-1 flex-shrink-0" />
                <p className="text-gray-400">No. 45, Main Street, Badulla, Uva Province, Sri Lanka</p>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-700 pt-8">
          <p className="text-center text-gray-400 text-sm">
            © 2025 Uva Event Masters. All rights reserved. |
